...
using MailCheck.Spf.Entity.Seeding.DomainCreated;
using MailCheck.Spf.Entity.Seeding.History;
...
namespace MailCheck.Spf.Entity
{
    public static class LocalEntryPoint
    {
        public static void Main(string[] args)
        {
            ...
            {
                CommandOption spfConnectionString = command.Option("-s", "SPF Connection String", CommandOptionType.SingleValue);
                ...
                command.OnExecute(() =>
                {
                    IHistoryMigrator historyMigrator =
                        HistoryMigratorFactory.Create(dmarcConnectionString.Value(), spfConnectionString.Value());

                    historyMigrator.Migrate().GetAwaiter().GetResult();
